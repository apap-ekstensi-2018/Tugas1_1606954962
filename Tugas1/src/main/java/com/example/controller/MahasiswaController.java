...
import com.example.service.FakultasServiceDatabase;
import com.example.service.MahasiswaServiceDatabase;
import com.example.service.ProgramStudiServiceDatabase;
import com.example.service.UniversitasServiceDatabase;
...
public class MahasiswaController {
	...
	public String viewPresentationGraduation(Model model, @RequestParam(value = "thn", required = false) String tahun,
		...
		model.addAttribute("infoPresentase", String.format("%s dari 100 Mahasiswa Telah Lulus", countMahasiswa));
